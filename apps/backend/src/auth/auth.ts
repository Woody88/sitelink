        ...
        organizationHooks: {
          afterCreateOrganization: async ({ organization, user }) => {
            ...
            try {
              ...
              console.log("[Auth] OrganizationCreated event emitted to store:", organization.id)
            } catch (error) {
              console.error("[Auth] Failed to emit OrganizationCreated event:", error)
            }
          },
        },
      }),
      ...
      session: {
        create: {
          before: async (session) => {
            ...
            console.log("[Auth] Session create hook - membership:", userMembership?.organizationId)
