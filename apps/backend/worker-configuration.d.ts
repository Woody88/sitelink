/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4f2827950631652c9dba2fa3468af2e2)
// Runtime types generated with workerd@1.20260212.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SyncBackendDO" | "LiveStoreClientDO" | "PdfProcessor";
	}
	interface Env {
		R2_BUCKET: R2Bucket;
		DB: D1Database;
		LOCAL_CONTAINER_URL: "http://localhost:3001";
		...
		PLAN_PROCESSING_WORKFLOW: Workflow<Parameters<import("./src/index").PlanProcessingWorkflow['run']>[0]['payload']>;
	}
}
