/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 351acae3a2a2043b04c3776eefbe0463)
// Runtime types generated with workerd@1.20260107.1 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SyncBackendDO" | "LiveStoreClientDO" | "PlanCoordinator" | "PdfProcessor";
	}
	interface Env {
		...
		SYNC_BACKEND_DO: DurableObjectNamespace /* SyncBackendDO from sitelink-backend */;
		LIVESTORE_CLIENT_DO: DurableObjectNamespace /* LiveStoreClientDO from sitelink-backend */;
		PLAN_COORDINATOR_DO: DurableObjectNamespace /* PlanCoordinator from sitelink-backend */;
		PDF_PROCESSOR: DurableObjectNamespace<import("./src/index").PdfProcessor>;
		R2_BUCKET: R2Bucket;
		DB: D1Database;
