/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 906b12c9813b2ccd7d97695ad62d98d2)
// Runtime types generated with workerd@1.20251210.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebSocketServer" | "LiveStoreClientDO";
	}
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		SYNC_BACKEND_DO: DurableObjectNamespace /* WebSocketServer from sitelink-backend */;
