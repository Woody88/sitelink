...
export function useAudioRecorder(): UseAudioRecorderReturn {
  ...
  const stopRecording = useCallback(async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setTranscript("Mock transcription: Junction box needs to move about six inches to the left to clear the conduit run")
  ...
  const generateWaveform = useCallback(async (audioUri: string): Promise<number[]> => {
