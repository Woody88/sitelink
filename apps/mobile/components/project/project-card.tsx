        ...
        <CardContent>
          <View className="flex-row gap-4">
            <View className="flex-row items-center">
              ...
              <Text className="text-muted-foreground text-sm">{project.sheetCount} sheets</Text>
            </View>
            <View className="flex-row items-center">
              <Users size={16} className="text-muted-foreground mr-1.5" />
              <Text className="text-muted-foreground text-sm">{project.memberCount} members</Text>
            </View>
          </View>
        </CardContent>
        <CardFooter className="border-border justify-between border-t pt-4">
          <Text className="text-muted-foreground text-xs">Updated {project.updatedAt}</Text>
        </CardFooter>
      </Card>
    </Pressable>
  )
