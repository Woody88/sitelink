        ...
        <View className="bg-background flex-1 items-center justify-center p-6">
          <View className="w-full max-w-md gap-4">
            <Text className="text-destructive text-center text-2xl font-bold">
              {isMaterializerError ? "Database Schema Mismatch" : "Something went wrong"}
            </Text>

            {isMaterializerError && (
              <>
                <Text className="text-muted-foreground text-center">
                  The local database schema doesn't match the current code. This happens during
                  development when schema changes.
                </Text>
                ...
                <Text className="text-muted-foreground text-center text-xs">
                  This will delete all local data and restart the app. Data will be resynced from
                  the server.
                </Text>
              </>
            )}
