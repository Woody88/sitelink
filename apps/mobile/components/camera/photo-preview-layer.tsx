      ...
      <View className="flex-1 bg-black">
        ...
        >
          <ScrollView className="max-h-96 px-4 pt-4" showsVerticalScrollIndicator={false}>
            ...
            {isOcrLoading && (
              <View className="mb-4">
                <Text className="mb-2 text-sm font-semibold text-white">📝 Text detected:</Text>
            ...
            {ocrText && !isOcrLoading && (
              <View className="mb-4">
                ...
                <View className="mb-2 rounded-lg bg-white/10 p-3">
                  <Text className="text-sm leading-relaxed text-white">{ocrText}</Text>
                </View>
            ...
            <View className="mb-4 flex-row gap-3">
              <Button onPress={onAddVoice} variant="outline" className="flex-1 border-white/30">
