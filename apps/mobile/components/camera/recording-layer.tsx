    ...
    return (
      ...
      >
        <View className="px-4 pt-4 pb-2">
          ...
          {isTranscribing && (
            <Text className="text-muted-foreground mb-4 text-xs">⏳ Transcribing...</Text>
          )}

          {transcript && !isTranscribing && (
            <View className="bg-muted/30 mb-4 rounded-lg p-3">
              <Text className="text-foreground text-sm leading-relaxed">{transcript}</Text>
            </View>
          )}
          ...
          <View className="flex-row gap-2">
            ...
            >
              ...
              <Text className="text-primary-foreground text-sm font-semibold">Play</Text>
            </Pressable>
            <Pressable
              onPress={onDelete}
            ...
            >
              ...
              <Text className="text-destructive text-sm font-semibold">Delete</Text>
            </Pressable>
            <Pressable
              onPress={onDone}
              className="bg-foreground flex-1 flex-row items-center justify-center gap-2 rounded-full px-4 py-3 active:opacity-80"
            >
              <Text className="text-background text-sm font-semibold">Done</Text>
            </Pressable>
          </View>
        </View>
      </View>
