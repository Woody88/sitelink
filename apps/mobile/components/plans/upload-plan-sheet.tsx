      ...
      <View className="bg-background flex-1">
        ...
        <View className="gap-4 p-6">
          ...
          <View className="bg-muted/5 flex-row items-center gap-4 rounded-2xl p-4 opacity-60">
            ...
            <View className="flex-1">
              <View className="flex-row items-center gap-2">
                <Text className="text-muted-foreground text-base font-bold">Google Drive</Text>
                <Badge variant="secondary" className="bg-primary/10 border-transparent">
                  <Text className="text-primary text-[10px] font-bold">COMING SOON</Text>
                </Badge>
              </View>
          ...
          <View className="bg-muted/5 flex-row items-center gap-4 rounded-2xl p-4 opacity-60">
            ...
            <View className="flex-1">
              <View className="flex-row items-center gap-2">
                <Text className="text-muted-foreground text-base font-bold">Dropbox</Text>
                <Badge variant="secondary" className="bg-primary/10 border-transparent">
                  <Text className="text-primary text-[10px] font-bold">COMING SOON</Text>
                </Badge>
              </View>
