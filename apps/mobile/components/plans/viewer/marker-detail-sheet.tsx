import { ArrowRight, Camera, ExternalLink, Layers, MapPin, X } from "lucide-react-native"
          ...
          <Pressable>
            ...
            <View className="flex-row items-start justify-between px-6 pb-4">
              <View className="flex-1">
                ...
                <Text className="text-foreground text-2xl font-bold">{marker.label}</Text>
              </View>

              <Pressable onPress={onClose} className="active:bg-muted/50 -m-2 rounded-full p-2">
              ...
              {marker.targetSheetRef && onNavigateToSheet && (
                ...
                >
                  <View className="flex-row items-center gap-3">
                    <Icon as={Layers} className="text-primary-foreground size-5" />
                    <View>
              ...
              {onTakePhoto && (
                ...
                >
                  <View className="flex-row items-center gap-3">
                    ...
                    <Text className="text-foreground text-base font-semibold">Take Photo Here</Text>
                  </View>
                  <Icon as={ExternalLink} className="text-muted-foreground size-5" />
                </Button>
              )}
            </View>
          </Pressable>
