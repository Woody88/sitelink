...
export default function PMTilesViewer({
    ...
    const initViewer = async () => {
      try {
        ...
        const meta: PMTilesMetadata = {
          ...
          center: [(header.minLon + header.maxLon) / 2, (header.minLat + header.maxLat) / 2],
          tileSize,
        }
        ...
        viewer.addHandler("open", () => {
          ...
          if (viewer) {
            ...
            console.log(
              "[PMTilesViewer] Viewport after goHome:",
              JSON.stringify(viewer.viewport.getBounds()),
            )
          }
  ...
  React.useEffect(() => {
    ...
    markers.forEach((marker) => {
      ...
      el.addEventListener("mouseleave", () => {
        if (!isSelected) labelEl.style.opacity = "0"
      })
