...
export function ScheduleRow({
  ...
  return (
    <View>
      ...
      >
        <Text className="w-14 text-base font-semibold text-foreground">{entry.mark}</Text>
        ...
        <View className={cn("px-4 pb-4", index % 2 === 1 && "bg-muted/10")}>
          ...
          <View className="mt-3 px-2">
            <Button onPress={handleViewOnSheet} className="h-12">
              ...
              <Text className="text-base font-semibold text-primary-foreground">View on Sheet</Text>
            </Button>
          </View>
        </View>
      )}
