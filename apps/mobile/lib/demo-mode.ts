...
export function seedDemoData(store: Store): void {
  ...
  store.commit(
    events.sheetCalloutsDetected({
      ...
      markers: [
        {
          id: "demo-marker-s2-00",
          label: "10/S2.0",
          targetSheetId: DEMO_SHEETS.S3,
          x: 0.4919,
          y: 0.7919,
          confidence: 0.985,
          needsReview: false,
  ...
  store.commit(
    events.sheetCalloutsDetected({
      ...
      markers: [
        {
          id: "demo-marker-s3-00",
          label: "14/S1.0",
          targetSheetId: DEMO_SHEETS.S2,
          x: 0.6337,
          y: 0.7843,
          confidence: 0.956,
          needsReview: false,
  ...
  store.commit(
    events.sheetLayoutRegionsDetected({
      ...
      regions: [
        ...
        {
          id: "demo-region-struct-notes",
          regionClass: "notes",
          regionTitle: "General Notes",
          x: 0.02,
          y: 0.45,
          width: 0.25,
          height: 0.3,
  ...
  store.commit(
    events.sheetLayoutRegionsDetected({
      ...
      regions: [
        {
          id: "demo-region-fdn-legend",
          regionClass: "legend",
          regionTitle: "Foundation Legend",
          x: 0.78,
          y: 0.02,
          width: 0.2,
          height: 0.15,
        ...
        {
          id: "demo-region-fdn-notes",
          regionClass: "notes",
          regionTitle: "Foundation Notes",
          x: 0.78,
          y: 0.18,
          width: 0.2,
          height: 0.15,
  ...
  store.commit(
    events.sheetLayoutRegionsDetected({
      ...
      regions: [
        {
          id: "demo-region-framing-notes",
          regionClass: "notes",
          regionTitle: "Framing Notes",
          x: 0.78,
          y: 0.02,
          width: 0.2,
          height: 0.12,
  ...
  console.log(
    "[DemoMode] Seeded demo data: 1 project, 4 sheets, 122 markers, 7 regions, 10 schedule entries",
  )
}
