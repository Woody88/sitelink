    ...
    >
      ...
      <ScrollView contentContainerClassName="px-4 pb-8">
        ...
        >
          ...
          <Text className="text-foreground mt-1 text-lg font-bold">12 days remaining</Text>
        ...
        <View className="gap-4">
          {TIERS.map((tier) => {
            ...
            return (
              ...
              >
                {tier.popular && (
                  <View className="items-center py-1.5" style={{ backgroundColor: tier.color }}>
                ...
                <View className="p-5">
                  <View className="flex-row items-baseline justify-between">
                    <View>
                      <Text className="text-lg font-bold" style={{ color: tier.color }}>
                        {tier.name}
                      </Text>
