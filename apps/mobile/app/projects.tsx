...
import { Bell, FolderOpen, MapPin, Moon, Plus, Sun, User } from "lucide-react-native"
import * as React from "react"
import { ActivityIndicator, Appearance, FlatList, Pressable, ScrollView, View } from "react-native"
    ...
    return (
      <>
        ...
        <View className="bg-background flex-1 items-center justify-center">
          ...
          <Text className="text-muted-foreground mt-4">Loading your workspace...</Text>
        </View>
      </>
    )
  }
