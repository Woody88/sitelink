		...
		>
			<View className="gap-3 px-5 py-4">
				...
				<Text className="text-muted-foreground text-sm leading-relaxed">
					Slab on Grade Schedule entry SL1 specifies 4000 PSI, but General
					Structural Note N3 requires 4500 PSI minimum for exposed slabs
				</Text>
...
function RfiLetterField({ label, value }: { label: string; value: string }) {
	return (
		<View className="flex-row">
			<Text className="text-muted-foreground w-16 text-xs font-semibold">
				{label}
			</Text>
