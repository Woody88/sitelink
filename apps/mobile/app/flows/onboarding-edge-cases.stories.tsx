		...
		<View className="bg-background flex-1 items-center justify-center" style={{ minHeight: "100vh" } as any}>
			<View className="items-center gap-6 px-8">
				<View
					...
					style={{ width: 72, height: 72, backgroundColor: "rgba(239,68,68,0.12)" }}
				>
...
function WelcomeWithDemoScreen({ onGetStarted, onDemo }: { onGetStarted: () => void; onDemo: () => void }) {
	return (
		<View className="bg-background flex-1 justify-between px-6 py-12">
			...
			<View className="gap-4 pt-8">
				...
				>
					...
					<Text className="text-sm font-semibold" style={{ color: "#22c55e" }}>Explore the Demo Project</Text>
				</Pressable>

				<Text className="text-muted-foreground text-center text-xs">No account needed for the demo</Text>
			</View>
		</View>
	);
}
...
export const WelcomeWithDemo: Story = { name: "3. Welcome + Demo", args: { screen: "welcome-demo" } };
