...
function VideoCaptureFlow({
  ...
  if (phase === "preview") {
    return (
      <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
        <Image
          source={{ uri: "https://picsum.photos/seed/vidpreview/1080/1920" }}
        ...
        >
          ...
          <View style={{ paddingHorizontal: 20, paddingBottom: 40 }}>
            ...
            <View className="flex-row items-center gap-3">
              ...
              <Pressable
                onPress={() => setToastMsg("Video saved")}
  ...
  return (
    <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
      <Image
        source={{ uri: "https://picsum.photos/seed/constructsite8/1080/1920" }}
        style={{ width: "100%", height: "100%", position: "absolute" }}
        resizeMode="cover"
      />
      ...
      <View style={{ position: "absolute", bottom: 126, left: 34, zIndex: 15 }}>
        ...
        >
          <Image
            source={{ uri: "https://picsum.photos/seed/vidthumb/200/200" }}
      ...
      >
        ...
        >
          <View
            className="items-center justify-center rounded-full"
            style={{ width: 88, height: 88, borderWidth: 3, borderColor: "#ef4444" }}
          >
            {phase === "recording" ? (
              <View
                className="rounded-lg"
                style={{ width: 30, height: 30, backgroundColor: "#ef4444" }}
              />
            ) : (
              <View
                className="rounded-full"
                style={{ width: 74, height: 74, backgroundColor: "#ef4444" }}
              />
            )}
          </View>
        </Pressable>
...
export const IssueModeViewfinder: Story = {
  name: "4. Issue Mode",
