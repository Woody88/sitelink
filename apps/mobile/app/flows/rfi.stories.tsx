          ...
          <View className="gap-3 px-5 py-4">
            ...
            <View className="flex-row gap-3">
              <View className="overflow-hidden rounded-lg" style={{ width: 80, height: 80 }}>
                <Image
                  source={{ uri: "https://picsum.photos/seed/rfi1/200/200" }}
      ...
      <View className="items-center gap-4 px-8">
        ...
        >
          <Text className="text-muted-foreground text-center text-xs">
            You will be notified when a response is received
          </Text>
        </View>
      </View>
    </View>
      ...
      <View className="flex-1 items-center justify-center px-8">
        <View className="items-center gap-6">
          ...
          <View className="items-center gap-2">
            ...
            <Text className="text-muted-foreground text-center text-sm leading-relaxed">
              Could not generate the RFI draft. This may be due to a network issue or insufficient
              context.
            </Text>
          </View>
...
function RfiFlow({ initialPhase = "context" as RfiPhase }: { initialPhase?: RfiPhase }) {
  ...
  if (phase === "draft" || phase === "editing")
    return <DraftView onEdit={() => setPhase("editing")} onSend={() => setPhase("sent")} />
...
export const AIGenerating: Story = {
  name: "2. AI Generating",
  args: { initialPhase: "generating" },
}
