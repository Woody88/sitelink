    ...
    return (
      ...
      >
        <View className="items-center gap-5 px-8">
          ...
          <Pressable
            onPress={() => setPhase("plan-view")}
            className="bg-primary items-center rounded-xl px-8 py-3.5"
          >
  ...
  if (phase === "capture-preview") {
    return (
      <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
        <Image
          source={{ uri: "https://picsum.photos/seed/rebar42/1080/1920" }}
        ...
        >
          <Pressable
            onPress={() => setPhase("camera-linked")}
            className="items-center justify-center rounded-full"
    ...
    <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#0a0a0a" } as any}>
      ...
      >
        ...
        >
          ...
          <View
            style={{ height: 1, backgroundColor: "rgba(255,255,255,0.1)", alignSelf: "stretch" }}
          />
          <Pressable className="items-center justify-center" style={{ width: 44, height: 44 }}>
        ...
        >
          ...
          <View className="mb-1 flex-row items-center gap-2">
            ...
            <View
              ...
              style={{ backgroundColor: MARKER_COLORS[selectedMarker.type] + "20" }}
            >
              <Text
                style={{
          ...
          <View className="gap-3 pt-2 pb-4">
            ...
            <View className="flex-row gap-3">
              <Button
                ...
                onPress={() => setToastMsg("RFI copied to clipboard")}
              >
              ...
              <Button
                variant="secondary"
                className="h-12 flex-1 rounded-xl"
                onPress={() => setToastMsg("Share link created")}
              >
      ...
      <View className="bg-background flex-1" style={{ minHeight: "100vh" } as any}>
        ...
        >
          ...
          <Text className="text-muted-foreground text-sm leading-relaxed">
            Rebar lacks adequate cover at electrical junction box location. May not meet ACI 318
          ...
          <View className="flex-row items-center gap-4">
            <View className="overflow-hidden rounded-lg" style={{ width: 72, height: 72 }}>
              <Image
                source={{ uri: "https://picsum.photos/seed/rebar42/200/200" }}
            ...
            <View className="flex-1 gap-1.5">
              ...
              <Text className="text-muted-foreground text-xs">
                Captured March 9, 2026 at 2:34 PM
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row items-center gap-3">
            <View
              className="items-center justify-center rounded-full"
              style={{ width: 36, height: 36, backgroundColor: "rgba(59,130,246,0.12)" }}
            >
            ...
            <View className="flex-1">
              ...
              <Text className="text-muted-foreground text-xs">
                &quot;Exposed rebar at junction box, needs inspection...&quot;
              </Text>
            </View>
            <Pressable
              className="items-center justify-center rounded-full"
              style={{ width: 32, height: 32, backgroundColor: "rgba(59,130,246,0.15)" }}
            >
    ...
    return (
      <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
        ...
        <View style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, zIndex: 40 }}>
          <Pressable
            onPress={() => setPhase("issue-preview")}
            style={{
              position: "absolute",
              top: 0,
              bottom: 0,
  ...
  if (phase === "issue-preview") {
    return (
      <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
        ...
        >
          <Pressable
            onPress={() => setPhase("issue-capture")}
            className="items-center justify-center rounded-full"
            style={{ width: 40, height: 40, backgroundColor: "rgba(0,0,0,0.5)" }}
          >
            <Icon as={ChevronLeft} className="size-5 text-white" />
  ...
  return (
    <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#000" } as any}>
      ...
      <View style={{ position: "absolute", bottom: 126, left: 34, zIndex: 15 }}>
        ...
        >
          <Image
            source={{ uri: "https://picsum.photos/seed/foundation55/200/200" }}
      ...
      <View style={{ position: "absolute", bottom: 120, right: 34, zIndex: 15 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 10, fontWeight: "700", color: "#ef4444", marginTop: 2 }}>
            Issue
          </Text>
        </View>
      </View>
