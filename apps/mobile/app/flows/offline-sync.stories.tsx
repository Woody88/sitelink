...
const MOCK_QUEUE: QueueItem[] = [
  {
    id: "q1",
    type: "photo",
    label: "Foundation pour — Grid A7",
    timestamp: "2:34 PM",
    size: "4.2 MB",
    thumbnail: "https://picsum.photos/seed/construct11/200/200",
    status: "pending",
  },
  {
    id: "q2",
    type: "photo",
    label: "Rebar at junction box",
    timestamp: "2:31 PM",
    size: "3.8 MB",
    thumbnail: "https://picsum.photos/seed/construct22/200/200",
    status: "pending",
  },
  {
    id: "q3",
    type: "photo",
    label: "Slab S2 — North side",
    timestamp: "1:55 PM",
    size: "5.1 MB",
    thumbnail: "https://picsum.photos/seed/construct33/200/200",
    status: "pending",
  },
  {
    id: "q4",
    type: "voice",
    label: "Note: Missing anchor bolts at F2",
    timestamp: "1:48 PM",
    size: "0.3 MB",
    thumbnail: "",
    status: "pending",
  ...
  return (
    ...
    >
      <Icon
        ...
        style={{ color: isOnline ? "#22c55e" : "#f59e0b" }}
        className="size-3.5"
      />
    ...
    <View style={{ flex: 1, position: "relative", backgroundColor: "#0a0a0a" }}>
        ...
        >
          <View
            style={{
              ...
              paddingVertical: 5,
              backgroundColor: marker.color + "26",
              borderWidth: 1.5,
              borderColor: marker.color,
            }}
          >
            <Text style={{ color: marker.color, fontSize: 12, fontWeight: "700" }}>
              {marker.label}
            </Text>
          </View>
        </View>
      ...
      {!isOnline && (
        <View style={{ position: "absolute", top: 100, left: 12, right: 60, zIndex: 15 }}>
          <View
            className="flex-row items-center gap-2.5 rounded-xl px-4 py-2.5"
            style={{
          ...
          >
            ...
            <Text style={{ color: "#f59e0b", fontSize: 12, fontWeight: "600" }}>
              Offline — cached sheets, AI paused
            </Text>
          </View>
        </View>
      )}
    ...
    <View style={{ flex: 1, position: "relative" }}>
      ...
      >
        <Pressable
          ...
          style={{ width: 48, height: 48, backgroundColor: "rgba(0,0,0,0.4)" }}
        >
      ...
      {captured && (
        <View style={{ position: "absolute", top: 110, left: 16, right: 16, zIndex: 25 }}>
          ...
          >
            <Icon as={Clock} style={{ color: "#f59e0b" }} className="size-5" />
            <View className="flex-1">
              <Text style={{ color: "#f59e0b", fontSize: 14, fontWeight: "700" }}>
                Queued for upload
              </Text>
              <Text style={{ color: "rgba(245,158,11,0.7)", fontSize: 12 }}>
        ...
        >
          ...
          >
            <View
              ...
              style={{ width: 74, height: 74, backgroundColor: "#ffffff" }}
            />
          </View>
        </Pressable>
      </View>
    ...
    <View style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, zIndex: 40 }}>
      ...
      >
        ...
        <View className="items-center px-6 pb-12 pt-4">
          <View className="mb-4">
            <Icon as={CheckCircle} style={{ color: "#22c55e" }} className="size-12" />
          </View>
          ...
          <View
            className="mt-6 flex-row items-center gap-2 rounded-full px-4 py-2"
            style={{ backgroundColor: "rgba(34,197,94,0.1)" }}
          >
      ...
      >
        ...
        <View className="px-6 pb-4">
          <View className="mb-4 flex-row items-center gap-3">
            <Icon as={AlertTriangle} style={{ color: "#f59e0b" }} className="size-6" />
            <View className="flex-1">
          ...
          >
            ...
            <Text className="text-muted-foreground mt-1 text-sm leading-relaxed">
              This photo was modified on another device while you were offline. Your version has
              different annotations.
            </Text>
            <View className="mt-3 flex-row items-center gap-4">
              <View className="flex-1">
                <Text className="text-muted-foreground mb-1 text-xs font-bold tracking-wider uppercase">
                  Your version
                </Text>
...
function OfflineSyncFlow({ initialPhase = "online" as FlowPhase }) {
  ...
  if (phase === "sync-queue" || phase === "syncing") {
    return (
      <View style={{ minHeight: "100vh", position: "relative", backgroundColor: "#0a0a0a" } as any}>
        <PlanViewerScreen
          isOnline={phase === "syncing"}
          pendingCount={phase === "syncing" ? undefined : queueItems.length}
        />
        <SyncQueueSheet
          items={queueItems}
