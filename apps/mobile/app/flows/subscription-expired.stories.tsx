			...
			<View className="flex-1 items-center justify-center px-8">
				...
				>
					<View
						...
						style={{ width: 72, height: 72, backgroundColor: "rgba(249,115,22,0.12)" }}
					>
						<Icon as={icon} className="size-8" style={{ color: "#f97316" }} />
					</View>
	...
	return (
		<View className="bg-background flex-1" style={{ minHeight: "100vh", position: "relative" } as any}>
			...
			<View className="px-4 pt-4">
				...
				<View className="mt-4 items-center rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(249,115,22,0.06)" }}>
	...
	return (
		<View className="bg-background flex-1" style={{ minHeight: "100vh", position: "relative" } as any}>
			...
			<View className="px-4 pt-4 gap-2">
				...
				<View className="mt-2 items-center rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(249,115,22,0.06)" }}>
					<Text className="text-sm font-medium" style={{ color: "#f97316" }}>
...
function SubscriptionExpiredFlow({ screen = "photo-blocked" as ScreenType }: { screen?: ScreenType }) {
	switch (screen) {
		case "photo-blocked":
...
export const ProjectLimitReached: Story = { name: "2. Project Limit", args: { screen: "project-limit" } };
export const MemberLimitReached: Story = { name: "3. Member Limit", args: { screen: "member-limit" } };
