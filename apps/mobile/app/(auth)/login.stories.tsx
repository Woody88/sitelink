...
function SignUpInline({ onSwitchToLogin }: { onSwitchToLogin: () => void }) {
    ...
    >
      ...
      >
        ...
        <View className="gap-4">
          <View className="gap-2">
            <Label nativeID="su-name-label">
              <Text>Name</Text>
            </Label>
            <Input
              nativeID="su-name-input"
              placeholder="Name"
              value={name}
          ...
          <View className="gap-2">
            <Label nativeID="su-email-label">
              <Text>Email</Text>
            </Label>
            <Input
              nativeID="su-email-input"
              placeholder="Email"
              value={email}
          ...
          <View className="gap-2">
            <Label nativeID="su-password-label">
              <Text>Password</Text>
            </Label>
            <Input
              nativeID="su-password-input"
          ...
          <View className="gap-2">
            <Label nativeID="su-org-label">
              <Text>Organization Name</Text>
            </Label>
            <Input
              nativeID="su-org-input"
    ...
    >
      ...
      >
        ...
        <View className="flex-row items-center justify-center gap-2">
          ...
          <Button variant="link" disabled={loading} onPress={() => setShowSignUp(true)}>
