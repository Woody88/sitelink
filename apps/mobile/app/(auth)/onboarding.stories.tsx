...
import { CreateProjectOverlay, StoryToast } from "@/app/_story-components"
    ...
    <ScrollView className="bg-background flex-1" contentContainerClassName="px-6 py-12">
      ...
      <View className="mt-8 gap-4">
        <Button onPress={onCreateProject}>
          <View className="flex-row items-center gap-2">
            <Text className="text-primary-foreground font-bold">Create First Project</Text>
            <Icon as={ArrowRight} className="text-primary-foreground size-4" />
          </View>
        </Button>
  ...
  return (
    <View className="bg-background flex-1" style={{ minHeight: "100vh" } as any}>
      ...
      <View className="flex-1 items-center justify-center px-8">
        ...
        <Text className="text-foreground mb-2 text-xl font-bold">{"You're All Set!"}</Text>
        <Text className="text-muted-foreground text-center text-sm leading-relaxed">
          Your project is ready. Upload a plan to get started with AI-powered callout detection and
          schedule extraction.
        </Text>
      </View>
    </View>
