...
function LoginInline({ onSwitchToSignUp }: { onSwitchToSignUp: () => void }) {
    ...
    >
      ...
      >
        ...
        <View className="gap-4">
          <View className="gap-2">
            <Label nativeID="li-email-label">
              <Text>Email</Text>
            </Label>
            <Input
              nativeID="li-email-input"
              placeholder="Email"
              value={email}
          ...
          <View className="gap-2">
            <Label nativeID="li-password-label">
              <Text>Password</Text>
            </Label>
            <Input
              nativeID="li-password-input"
    ...
    >
      ...
      >
        ...
        <View className="flex-row items-center justify-center gap-2">
          ...
          <Button variant="link" disabled={loading} onPress={() => setShowLogin(true)}>
