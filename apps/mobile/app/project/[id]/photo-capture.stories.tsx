...
const MOCK_LOCATIONS: PlanLocation[] = [
	{ id: "loc1", label: "5/A7", sheetNumber: "S1.0", sheetTitle: "Foundation Plan", type: "detail", confidence: 0.96 },
	{ id: "loc2", label: "3/A2", sheetNumber: "S1.0", sheetTitle: "Foundation Plan", type: "section", confidence: 0.91 },
	{ id: "loc3", label: "2/A1", sheetNumber: "S2.0", sheetTitle: "Structural Details", type: "detail", confidence: 0.88 },
...
function ShutterButton({
	...
	return (
		<Pressable onPress={onPress}>
			...
			>
				<View className="rounded-full" style={{ width: 58, height: 58, backgroundColor: outerColor }} />
			</View>
		</Pressable>
	);
}
				...
				{linkedLocation ? (
					...
					>
						...
						>
							...
							<View className="flex-1">
								...
								<Text className="text-muted-foreground text-xs">
									Sheet {linkedLocation.sheetNumber} — {linkedLocation.type.charAt(0).toUpperCase() + linkedLocation.type.slice(1)} callout
								</Text>
							</View>
						</View>
						...
						{hasVoiceNote && (
							<View className="mx-4 mb-3 flex-row items-center gap-3 rounded-xl px-3 py-2.5" style={{ backgroundColor: "rgba(255,255,255,0.05)" }}>
								<View
									className="items-center justify-center rounded-full"
								...
								<View className="flex-row items-center gap-1.5 rounded bg-blue-500/10 px-2 py-1">
									...
									<Text style={{ color: "#3b82f6" }} className="text-xs font-semibold">Play</Text>
								</View>
							</View>
						)}
					...
					>
						<View className="flex-row items-center gap-3 px-4 py-4">
							...
							<Pressable
								onPress={onChangeLink}
								className="bg-primary rounded-full px-3.5 py-2"
							>
