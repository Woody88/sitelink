            ...
            {[
              {
                icon: ScanLine,
                color: "#f59e0b",
                text: "AI scans every sheet for callout symbols",
              },
              {
                icon: Link2,
                color: "#22c55e",
...
function FirstRunScreen({ initialPhase = "upload" }: { initialPhase?: FirstRunPhase }) {
  ...
  if (phase === "processing") {
    return <ProcessingScreen autoAdvance onComplete={() => setPhase("reveal")} />
  }

  return <RevealScreen onViewSheet={() => {}} onViewAll={() => {}} />
}
