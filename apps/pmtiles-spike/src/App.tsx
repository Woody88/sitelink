...
export default function App() {
  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <p>Proof-of-concept for deep zoom viewing of tiled images via PMTiles</p>
      </header>
        ...
        <div className="viewer-container">
          {isLoaded && pmtilesUrl ? (
            ...
            <div style={{ padding: "2rem", color: "white" }}>
              <p>No PMTiles file loaded. Use the panel on the right to load a file.</p>
            </div>
          )}
        </div>
  ...
  --image_format=webp`}</code>
            ...
            >
              ...
              <code style={{ fontSize: "0.75rem" }}>vips dzsave image.jpg tmp_tiles ...</code>
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ fontSize: "0.875rem", lineHeight: "1.5" }}>
              This spike uses the <code>imageLoader.addJob</code> override pattern from the
              OpenSeadragon docs. Tiles are loaded from PMTiles via custom protocol (
              <code>pmtiles://z/x/y</code>) and converted to blob URLs for display.
            </p>
          </section>
        </aside>
      </main>
