...
export default function App() {
  ...
  --suffix ".webp[Q=75]"`}</code></pre>
              ...
              <li>
                Pack to MBTiles:
                <pre><code>{`mb-util tmp_tiles/ plan.mbtiles \\
  --scheme=zyx \\
  --image_format=webp`}</code></pre>
          ...
          <section>
            ...
            <p style={{ fontSize: "0.875rem", lineHeight: "1.5" }}>
              This spike uses the <code>imageLoader.addJob</code> override pattern from
              the OpenSeadragon docs. Tiles are loaded from PMTiles via custom protocol
